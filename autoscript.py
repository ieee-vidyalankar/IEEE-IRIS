...
def sending_mail(email_sender, email_receiver, names, password):
    ...
    msg['subject']= subject
    body = """Greetings %s
Thank you for attending a seminar on Google Crowdsourcing by CSI-VIT and IEEE-VIT. Attached is your e-certificate for the same.

Due to unforeseen circumstances, there has been a delay in the delivery of the goodies. We assure you that the goodies will be distributed within two weeks. We regret the inconvenience caused.

Regards,
CSI-VIT Student Branch,
IEEE-VIT Student Branch"""%names
